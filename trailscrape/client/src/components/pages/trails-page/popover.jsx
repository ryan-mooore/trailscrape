  ...
  return (
    ...
    >
      <div class="sm:relative p-4 sm:w-80 bg-gray-500 rounded-md text-gray-300 text-sm">
        <div class="sm:hidden pb-3 sm:pb-0 flex flex-row justify-end"><div class="material-icons-round">close</div></div>
        <p>
        This trail status was automatically generated from a Trailforks status log. If this status is incorrect, you can <a class="underline" href={`https://trailforks.com/contribute/report/?trailid=${props.id}`}>add a new report</a>.
        </p>
